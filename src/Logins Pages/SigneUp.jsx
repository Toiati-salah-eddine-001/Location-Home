...
function SigneUp() {
  ...
  const handelsubmit = async (e) => {
    ...
    if (password !== PasswordConfirmation) {
      return seterror("Password confirmation incorrect");
    }
    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="https://images.unsplash.com/photo-1605266764154-0ff8f354088c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZG9taWNpbGV8ZW58MHx8MHx8fDA%3D"
          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            >
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                <button
                  className="inline-block shrink-0 rounded-md border border-orange-600 bg-orange-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-orange-600 focus:ring-3 focus:outline-hidden"
                  disabled={Loading}
                  type="submit"
                >
                  Create an account
